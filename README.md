...
*PDFGeneratorAPI::TemplatesApi* | [**merge_template**](docs/TemplatesApi.md#merge_template) | **POST** /templates/{templateId}/output | Merge template
*PDFGeneratorAPI::TemplatesApi* | [**merge_templates**](docs/TemplatesApi.md#merge_templates) | **POST** /templates/output | Merge multiple templates
