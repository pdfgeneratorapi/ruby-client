...
```shell
gem install ./pdf_generator_api_client-4.0.25.gem
```

(for development, run `gem install --dev ./pdf_generator_api_client-4.0.25.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'pdf_generator_api_client', '~> 4.0.25'
