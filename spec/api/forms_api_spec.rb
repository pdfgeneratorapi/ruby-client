...
# Unit tests for PDFGeneratorAPI::FormsApi
...
describe 'FormsApi' do
  ...
  describe 'test an instance of FormsApi' do
    it 'should create an instance of FormsApi' do
      expect(@api_instance).to be_instance_of(PDFGeneratorAPI::FormsApi)
    end
  end
  ...
  # @param form_configuration_new Form configuration
  ...
  # @param import_form_request Import editable PDF via URL or base64 string as form
  # @param [Hash] opts the optional parameters
  # @return [InlineObject17]
  describe 'import_form test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for open_form_builder
  ...
  describe 'open_form_builder test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for open_form_builder_for_existing_form
  ...
  # @param [Hash] opts the optional parameters
  # @return [InlineObject19]
  describe 'open_form_builder_for_existing_form test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for share_form
  # Share form
  # Creates an unique sharing URL to collect form data
  # @param form_id Form unique identifier
  # @param [Hash] opts the optional parameters
  # @return [InlineObject18]
  describe 'share_form test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
