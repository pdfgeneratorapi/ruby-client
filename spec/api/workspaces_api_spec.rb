...
# Unit tests for PDFGeneratorAPI::WorkspacesApi
...
describe 'WorkspacesApi' do
  ...
  describe 'test an instance of WorkspacesApi' do
    it 'should create an instance of WorkspacesApi' do
      expect(@api_instance).to be_instance_of(PDFGeneratorAPI::WorkspacesApi)
    end
  end
  ...
  # @param workspace_identifier Workspace identifier
  # @param [Hash] opts the optional parameters
  # @return [nil]
