...
# Unit tests for PDFGeneratorAPI::TemplateVersionsApi
...
describe 'TemplateVersionsApi' do
  ...
  describe 'test an instance of TemplateVersionsApi' do
    it 'should create an instance of TemplateVersionsApi' do
      expect(@api_instance).to be_instance_of(PDFGeneratorAPI::TemplateVersionsApi)
    end
  end
  ...
  # @param template_version Unique ID of the template version.
  ...
  # unit tests for promote_template_version
  ...
  describe 'promote_template_version test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
