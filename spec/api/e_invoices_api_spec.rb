...
# Unit tests for PDFGeneratorAPI::EInvoicesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EInvoicesApi' do
  before do
  ...
  describe 'test an instance of EInvoicesApi' do
    it 'should create an instance of EInvoicesApi' do
      expect(@api_instance).to be_instance_of(PDFGeneratorAPI::EInvoicesApi)
    end
  end

  # unit tests for create_e_invoice
  # Create eInvoice
  ...
  # @param create_e_invoice_request eInvoice conversion
  # @param [Hash] opts the optional parameters
  # @return [InlineObject]
  describe 'create_e_invoice test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_factur_xe_invoice
  ...
  # @param create_factur_xe_invoice_request eInvoice conversion
  # @param [Hash] opts the optional parameters
  # @return [InlineObject9]
  describe 'create_factur_xe_invoice test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_x_rechnung_e_invoice
  ...
  # @param [Hash] opts the optional parameters
  # @return [InlineObject]
  describe 'create_x_rechnung_e_invoice test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_e_invoice_schema
  # Get schema
  # Returns e-invoice JSON schema which defines the structure of the e-invoice.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'get_e_invoice_schema test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
