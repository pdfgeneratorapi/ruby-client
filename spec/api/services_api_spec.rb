...
# Unit tests for PDFGeneratorAPI::ServicesApi
...
describe 'ServicesApi' do
  ...
  describe 'test an instance of ServicesApi' do
    it 'should create an instance of ServicesApi' do
      expect(@api_instance).to be_instance_of(PDFGeneratorAPI::ServicesApi)
    end
  end

  # unit tests for add_watermark
  # Add watermark
  # Adds a text or an image watermark to PDF document from base64 string or a remote URL.
  # @param add_watermark_request 
  # @param [Hash] opts the optional parameters
  # @return [InlineObject9]
  describe 'add_watermark test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for decrypt_document
  # Decrypt document
  # Decrypts an encrypted PDF document from base64 string or a remote URL.
  # @param encrypt_document_request 
  # @param [Hash] opts the optional parameters
  # @return [InlineObject9]
  describe 'decrypt_document test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for encrypt_document
  # Encrypt document
  # Encrypts a PDF document from base64 string or a remote URL.
  # @param encrypt_document_request 
  # @param [Hash] opts the optional parameters
  # @return [InlineObject9]
  describe 'encrypt_document test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for extract_form_fields
  # Extract form fields
  # Extracts form fields and their metadata from a PDF document using base64 string or a remote URL.
  # @param extract_form_fields_request 
  # @param [Hash] opts the optional parameters
  # @return [InlineObject14]
  describe 'extract_form_fields test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for fill_form_fields
  # Fill form fields
  # Fills form fields in a PDF document with provided data from base64 string or a remote URL.
  # @param fill_form_fields_request 
  # @param [Hash] opts the optional parameters
  # @return [InlineObject9]
  describe 'fill_form_fields test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for make_accessible
  # Make accessible
  # Tags a PDF document for accessibility from base64 string or a remote URL.
  # @param make_accessible_request 
  # @param [Hash] opts the optional parameters
  # @return [InlineObject9]
  describe 'make_accessible test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for optimize_document
  # Optimize document
  # Optimizes the size of a PDF document from base64 string or a remote URL.
  # @param optimize_document_request 
  # @param [Hash] opts the optional parameters
  # @return [InlineObject12]
  describe 'optimize_document test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
