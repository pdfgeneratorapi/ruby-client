...
# Unit tests for PDFGeneratorAPI::TemplatesApi
...
describe 'TemplatesApi' do
  ...
  describe 'test an instance of TemplatesApi' do
    it 'should create an instance of TemplatesApi' do
      expect(@api_instance).to be_instance_of(PDFGeneratorAPI::TemplatesApi)
    end
  end
  ...
  # @param template_definition_new Template configuration
  # @param [Hash] opts the optional parameters
  # @return [InlineObject16]
  ...
  # unit tests for get_template_data
  ...
  describe 'get_template_data test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @option opts [String] :access Filter template by access type. No values returns all templates. private - returns only private templates, organization - returns only organization templates.
  ...
  # @param import_template_request Import a PDF via URL or base64 string as template
  # @param [Hash] opts the optional parameters
  # @return [InlineObject16]
  ...
  # @param template_id Template unique identifier
  # @param open_editor_request 
  # @param [Hash] opts the optional parameters
  # @return [InlineObject3]
  describe 'open_editor test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'validate_template test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
