...
# Unit tests for PDFGeneratorAPI::DocumentsApi
...
describe 'DocumentsApi' do
  ...
  describe 'test an instance of DocumentsApi' do
    it 'should create an instance of DocumentsApi' do
      expect(@api_instance).to be_instance_of(PDFGeneratorAPI::DocumentsApi)
    end
  end
  ...
  # @param public_id Resource public id
  ...
  # unit tests for generate_document
  # Generate document
  ...
  # @param generate_document_request Request parameters, including template id, data and formats.
  # @param [Hash] opts the optional parameters
  # @return [InlineObject9]
  describe 'generate_document test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for generate_document_asynchronous
  ...
  # @param generate_document_asynchronous_request Request parameters, including template id, data and formats.
  # @param [Hash] opts the optional parameters
  # @return [InlineObject22]
  describe 'generate_document_asynchronous test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for generate_document_batch
  ...
  # @param generate_document_batch_request Request parameters, including template id, data and formats.
  # @param [Hash] opts the optional parameters
  # @return [InlineObject9]
  describe 'generate_document_batch test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for generate_document_batch_asynchronous
  # Generate document (batch + async)
  # Merges template with data as asynchronous job and makes POST request to callback URL defined in the request. Request uses the same format as response of synchronous generation endpoint. The job id is also added to the callback request as header PDF-API-Job-Id  *Example response from callback URL:* &#x60;&#x60;&#x60; {   \&quot;response\&quot;: \&quot;https://us1.pdfgeneratorapi.com/share/12821/VBERi0xLjcKJeLjz9MKNyAwIG9i\&quot;,   \&quot;meta\&quot;: {     \&quot;name\&quot;: \&quot;a2bd25b8921f3dc7a440fd7f427f90a4.pdf\&quot;,     \&quot;display_name\&quot;: \&quot;a2bd25b8921f3dc7a440fd7f427f90a4\&quot;,     \&quot;encoding\&quot;: \&quot;binary\&quot;,     \&quot;content-type\&quot;: \&quot;application/pdf\&quot;   } } &#x60;&#x60;&#x60; 
  # @param generate_document_batch_asynchronous_request Request parameters, including template id, data and formats.
  # @param [Hash] opts the optional parameters
  # @return [InlineObject22]
  describe 'generate_document_batch_asynchronous test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @option opts [Integer] :page Pagination: page to return
  # @option opts [Integer] :per_page Pagination: How many records to return per page
  ...
  # unit tests for store_document
  # Store document
  # Uploads a PDF as a URL or a base64 encoded string.
  # @param store_document_request Document source and optional metadata. Exactly one of &#x60;file_base64&#x60; or &#x60;file_url&#x60; is required.
  # @param [Hash] opts the optional parameters
  # @return [InlineObject11]
  describe 'store_document test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
