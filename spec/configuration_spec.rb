...
describe PDFGeneratorAPI::Configuration do
  let(:config) { PDFGeneratorAPI::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://us1.pdfgeneratorapi.com/api/v3")
    # PDFGeneratorAPI.configure do |c|
    #   c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      # expect(config.base_url).to eq("https://us1.pdfgeneratorapi.com/api/v3")
    end
