...
# Unit tests for PDFGeneratorAPI::GenerateDocumentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::GenerateDocumentRequest do
  let(:instance) { PDFGeneratorAPI::GenerateDocumentRequest.new }

  describe 'test an instance of GenerateDocumentRequest' do
    it 'should create an instance of GenerateDocumentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PDFGeneratorAPI::GenerateDocumentRequest)
    end
  end
