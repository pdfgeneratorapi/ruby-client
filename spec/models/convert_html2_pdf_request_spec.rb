...
# Unit tests for PDFGeneratorAPI::ConvertHTML2PDFRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::ConvertHTML2PDFRequest do
  let(:instance) { PDFGeneratorAPI::ConvertHTML2PDFRequest.new }

  describe 'test an instance of ConvertHTML2PDFRequest' do
    it 'should create an instance of ConvertHTML2PDFRequest' do
      expect(instance).to be_instance_of(PDFGeneratorAPI::ConvertHTML2PDFRequest)
    end
  end
  ...
  describe 'test attribute "paper_size"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["a0", "a1", "a2", "a3", "a4", "legal", "tabloid"])
      # validator.allowable_values.each do |value|
      #   expect { instance.paper_size = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "output"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["base64", "file"])
      # validator.allowable_values.each do |value|
