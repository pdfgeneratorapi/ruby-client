...
# Unit tests for PDFGeneratorAPI::InlineObject14ResponseValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::InlineObject14ResponseValue do
  let(:instance) { PDFGeneratorAPI::InlineObject14ResponseValue.new }

  describe 'test an instance of InlineObject14ResponseValue' do
    it 'should create an instance of InlineObject14ResponseValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PDFGeneratorAPI::InlineObject14ResponseValue)
    end
  end
