...
# Unit tests for PDFGeneratorAPI::TemplateDefinitionNew
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::TemplateDefinitionNew do
  let(:instance) { PDFGeneratorAPI::TemplateDefinitionNew.new }

  describe 'test an instance of TemplateDefinitionNew' do
    it 'should create an instance of TemplateDefinitionNew' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PDFGeneratorAPI::TemplateDefinitionNew)
    end
  end
  ...
  describe 'test attribute "data_settings"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "font_subsetting"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "barcode_as_image"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
