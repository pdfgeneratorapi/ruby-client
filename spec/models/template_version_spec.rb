...
# Unit tests for PDFGeneratorAPI::TemplateVersion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::TemplateVersion do
  let(:instance) { PDFGeneratorAPI::TemplateVersion.new }

  describe 'test an instance of TemplateVersion' do
    it 'should create an instance of TemplateVersion' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PDFGeneratorAPI::TemplateVersion)
    end
  end
