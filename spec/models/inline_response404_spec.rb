...
# Unit tests for PDFGeneratorAPI::InlineResponse404
...
describe 'InlineResponse404' do
  ...
  describe 'test an instance of InlineResponse404' do
    it 'should create an instance of InlineResponse404' do
      expect(@instance).to be_instance_of(PDFGeneratorAPI::InlineResponse404)
    end
  end
  describe 'test attribute "error"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Entity not found", "Resource not found"])
