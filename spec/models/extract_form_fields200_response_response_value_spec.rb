...
# Unit tests for PDFGeneratorAPI::ExtractFormFields200ResponseResponseValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::ExtractFormFields200ResponseResponseValue do
  let(:instance) { PDFGeneratorAPI::ExtractFormFields200ResponseResponseValue.new }

  describe 'test an instance of ExtractFormFields200ResponseResponseValue' do
    it 'should create an instance of ExtractFormFields200ResponseResponseValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PDFGeneratorAPI::ExtractFormFields200ResponseResponseValue)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["textfield", "datefield", "checkbox", "radiobuttongroup", "combobox", "listbox"])
  ...
  describe 'test attribute "maxlen"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
