...
# Unit tests for PDFGeneratorAPI::InlineResponse401
...
describe 'InlineResponse401' do
  ...
  describe 'test an instance of InlineResponse401' do
    it 'should create an instance of InlineResponse401' do
      expect(@instance).to be_instance_of(PDFGeneratorAPI::InlineResponse401)
    end
  end
  describe 'test attribute "error"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Authentication failed", "Required parameter missing"])
