...
# Unit tests for PDFGeneratorAPI::TemplateDefinitionEditor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TemplateDefinitionEditor' do
  before do
  ...
  describe 'test an instance of TemplateDefinitionEditor' do
    it 'should create an instance of TemplateDefinitionEditor' do
      expect(@instance).to be_instance_of(PDFGeneratorAPI::TemplateDefinitionEditor)
    end
  end
  describe 'test attribute "height_multiplier"' do
    it 'should work' do
