...
# Unit tests for PDFGeneratorAPI::TemplateDefinitionNewPagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::TemplateDefinitionNewPagesInner do
  let(:instance) { PDFGeneratorAPI::TemplateDefinitionNewPagesInner.new }

  describe 'test an instance of TemplateDefinitionNewPagesInner' do
    it 'should create an instance of TemplateDefinitionNewPagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PDFGeneratorAPI::TemplateDefinitionNewPagesInner)
    end
  end
