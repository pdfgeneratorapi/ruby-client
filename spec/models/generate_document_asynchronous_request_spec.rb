...
# Unit tests for PDFGeneratorAPI::GenerateDocumentAsynchronousRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::GenerateDocumentAsynchronousRequest do
  let(:instance) { PDFGeneratorAPI::GenerateDocumentAsynchronousRequest.new }

  describe 'test an instance of GenerateDocumentAsynchronousRequest' do
    it 'should create an instance of GenerateDocumentAsynchronousRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PDFGeneratorAPI::GenerateDocumentAsynchronousRequest)
    end
  end
  ...
  describe 'test attribute "make_accessible"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
