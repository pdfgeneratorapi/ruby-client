...
# Unit tests for PDFGeneratorAPI::TemplateDefinition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::TemplateDefinition do
  let(:instance) { PDFGeneratorAPI::TemplateDefinition.new }

  describe 'test an instance of TemplateDefinition' do
    it 'should create an instance of TemplateDefinition' do
      expect(instance).to be_instance_of(PDFGeneratorAPI::TemplateDefinition)
    end
  end
