...
# Unit tests for PDFGeneratorAPI::TemplateDefinitionNewPages
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TemplateDefinitionNewPages' do
  before do
  ...
  describe 'test an instance of TemplateDefinitionNewPages' do
    it 'should create an instance of TemplateDefinitionNewPages' do
      expect(@instance).to be_instance_of(PDFGeneratorAPI::TemplateDefinitionNewPages)
    end
  end
