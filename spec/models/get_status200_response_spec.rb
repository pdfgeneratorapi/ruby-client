...
# Unit tests for PDFGeneratorAPI::GetStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::GetStatus200Response do
  let(:instance) { PDFGeneratorAPI::GetStatus200Response.new }

  describe 'test an instance of GetStatus200Response' do
    it 'should create an instance of GetStatus200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PDFGeneratorAPI::GetStatus200Response)
    end
  end
  ...
  describe 'test attribute "api"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ok", "failed"])
      # validator.allowable_values.each do |value|
      #   expect { instance.api = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "chart_api"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ok", "failed"])
      # validator.allowable_values.each do |value|
      #   expect { instance.chart_api = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "conversion_api"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ok", "failed"])
      # validator.allowable_values.each do |value|
      #   expect { instance.conversion_api = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "generator_api_sync"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ok", "failed"])
      # validator.allowable_values.each do |value|
      #   expect { instance.generator_api_sync = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "generator_api_async"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ok", "failed"])
      # validator.allowable_values.each do |value|
      #   expect { instance.generator_api_async = value }.not_to raise_error
      # end
    end
  end
