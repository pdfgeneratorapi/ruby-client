...
# Unit tests for PDFGeneratorAPI::Component
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::Component do
  let(:instance) { PDFGeneratorAPI::Component.new }

  describe 'test an instance of Component' do
    it 'should create an instance of Component' do
      expect(instance).to be_instance_of(PDFGeneratorAPI::Component)
    end
  end
  describe 'test attribute "cls"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["labelComponent", "numberComponent", "textComponent", "imageComponent", "dateComponent", "hlineComponent", "vlineComponent", "tableComponent", "compositeComponent", "barcodeComponent", "qrcodeComponent", "chartComponent", "rectangleComponent", "headerComponent", "footerComponent", "checkboxComponent", "radioComponent"])
      # validator.allowable_values.each do |value|
      #   expect { instance.cls = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "zindex"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "data_index"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
