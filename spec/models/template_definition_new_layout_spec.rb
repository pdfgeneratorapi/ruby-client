...
# Unit tests for PDFGeneratorAPI::TemplateDefinitionNewLayout
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::TemplateDefinitionNewLayout do
  let(:instance) { PDFGeneratorAPI::TemplateDefinitionNewLayout.new }

  describe 'test an instance of TemplateDefinitionNewLayout' do
    it 'should create an instance of TemplateDefinitionNewLayout' do
      expect(instance).to be_instance_of(PDFGeneratorAPI::TemplateDefinitionNewLayout)
    end
  end
  describe 'test attribute "format"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["A4", "letter", "custom"])
  ...
  describe 'test attribute "unit"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cm", "in"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "orientation"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["portrait", "landscape"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "rotaion"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', [0, 90, 180, 270])
      # validator.allowable_values.each do |value|
      #   expect { instance.rotaion = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "repeat_layout"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "empty_labels"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
