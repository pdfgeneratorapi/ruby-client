...
# Unit tests for PDFGeneratorAPI::ConvertPDF2ImageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::ConvertPDF2ImageRequest do
  let(:instance) { PDFGeneratorAPI::ConvertPDF2ImageRequest.new }

  describe 'test an instance of ConvertPDF2ImageRequest' do
    it 'should create an instance of ConvertPDF2ImageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PDFGeneratorAPI::ConvertPDF2ImageRequest)
    end
  end
  ...
  describe 'test attribute "format"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["png", "jpeg", "jpg"])
