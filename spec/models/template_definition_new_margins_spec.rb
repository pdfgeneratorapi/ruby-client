...
# Unit tests for PDFGeneratorAPI::TemplateDefinitionNewMargins
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TemplateDefinitionNewMargins' do
  before do
  ...
  describe 'test an instance of TemplateDefinitionNewMargins' do
    it 'should create an instance of TemplateDefinitionNewMargins' do
      expect(@instance).to be_instance_of(PDFGeneratorAPI::TemplateDefinitionNewMargins)
    end
  end
