...
# Unit tests for PDFGeneratorAPI::TemplateDefinitionLayout
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::TemplateDefinitionLayout do
  let(:instance) { PDFGeneratorAPI::TemplateDefinitionLayout.new }

  describe 'test an instance of TemplateDefinitionLayout' do
    it 'should create an instance of TemplateDefinitionLayout' do
      expect(instance).to be_instance_of(PDFGeneratorAPI::TemplateDefinitionLayout)
    end
  end
