...
# Unit tests for PDFGeneratorAPI::ConvertURL2PDFRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PDFGeneratorAPI::ConvertURL2PDFRequest do
  let(:instance) { PDFGeneratorAPI::ConvertURL2PDFRequest.new }

  describe 'test an instance of ConvertURL2PDFRequest' do
    it 'should create an instance of ConvertURL2PDFRequest' do
      expect(instance).to be_instance_of(PDFGeneratorAPI::ConvertURL2PDFRequest)
    end
  end
