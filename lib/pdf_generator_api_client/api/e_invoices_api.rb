...
module PDFGeneratorAPI
  class EInvoicesApi
    ...
    # @param create_e_invoice_request [CreateEInvoiceRequest] eInvoice conversion
    # @param [Hash] opts the optional parameters
    # @return [InlineObject]
    def create_e_invoice(create_e_invoice_request, opts = {})
      data, _status_code, _headers = create_e_invoice_with_http_info(create_e_invoice_request, opts)
      data
    end
    ...
    def create_e_invoice_with_http_info(create_e_invoice_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EInvoicesApi.create_e_invoice ...'
      end
      # verify the required parameter 'create_e_invoice_request' is set
      if @api_client.config.client_side_validation && create_e_invoice_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_e_invoice_request' when calling EInvoicesApi.create_e_invoice"
      end
      # resource path
      local_var_path = '/einvoice'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_e_invoice_request)
      ...
      new_options = opts.merge(
        :operation => :"EInvoicesApi.create_e_invoice",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EInvoicesApi#create_e_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param create_factur_xe_invoice_request [CreateFacturXEInvoiceRequest] eInvoice conversion
    # @param [Hash] opts the optional parameters
    # @return [InlineObject9]
    def create_factur_xe_invoice(create_factur_xe_invoice_request, opts = {})
      data, _status_code, _headers = create_factur_xe_invoice_with_http_info(create_factur_xe_invoice_request, opts)
      data
    end
    ...
    def create_factur_xe_invoice_with_http_info(create_factur_xe_invoice_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EInvoicesApi.create_factur_xe_invoice ...'
      end
      # verify the required parameter 'create_factur_xe_invoice_request' is set
      if @api_client.config.client_side_validation && create_factur_xe_invoice_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_factur_xe_invoice_request' when calling EInvoicesApi.create_factur_xe_invoice"
      end
      # resource path
      local_var_path = '/einvoice/facturx'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_factur_xe_invoice_request)
      ...
      new_options = opts.merge(
        :operation => :"EInvoicesApi.create_factur_xe_invoice",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EInvoicesApi#create_factur_xe_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [InlineObject]
    def create_x_rechnung_e_invoice(create_e_invoice_request, opts = {})
      data, _status_code, _headers = create_x_rechnung_e_invoice_with_http_info(create_e_invoice_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineObject, Integer, Hash)>] InlineObject data, response status code and response headers
    def create_x_rechnung_e_invoice_with_http_info(create_e_invoice_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EInvoicesApi.create_x_rechnung_e_invoice ...'
      end
      # verify the required parameter 'create_e_invoice_request' is set
      if @api_client.config.client_side_validation && create_e_invoice_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_e_invoice_request' when calling EInvoicesApi.create_x_rechnung_e_invoice"
      end
      # resource path
      local_var_path = '/einvoice/xrechnung'
      ...
      new_options = opts.merge(
        :operation => :"EInvoicesApi.create_x_rechnung_e_invoice",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EInvoicesApi#create_x_rechnung_e_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def get_e_invoice_schema(opts = {})
      data, _status_code, _headers = get_e_invoice_schema_with_http_info(opts)
      data
    end
    ...
    def get_e_invoice_schema_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EInvoicesApi.get_e_invoice_schema ...'
      end
      # resource path
      local_var_path = '/einvoice/schema'
      ...
      new_options = opts.merge(
        :operation => :"EInvoicesApi.get_e_invoice_schema",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EInvoicesApi#get_e_invoice_schema\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
