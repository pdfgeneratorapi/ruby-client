...
module PDFGeneratorAPI
  class WorkspacesApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [CreateWorkspaceRequest] :create_workspace_request 
    # @return [Array<(CreateWorkspace201Response, Integer, Hash)>] CreateWorkspace201Response data, response status code and response headers
    def create_workspace_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateWorkspace201Response'
    ...
    # @param workspace_identifier [String] Workspace identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(DeleteWorkspace204Response, Integer, Hash)>] DeleteWorkspace204Response data, response status code and response headers
    def delete_workspace_with_http_info(workspace_identifier, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DeleteWorkspace204Response'
