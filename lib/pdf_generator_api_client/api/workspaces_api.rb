...
module PDFGeneratorAPI
  class WorkspacesApi
    ...
    # @param workspace_id [String] Workspace identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetWorkspace200Response, Integer, Hash)>] GetWorkspace200Response data, response status code and response headers
    def get_workspace_with_http_info(workspace_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetWorkspace200Response'
