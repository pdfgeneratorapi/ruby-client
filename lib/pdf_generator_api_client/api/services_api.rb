...
module PDFGeneratorAPI
  class ServicesApi
    ...
    # @param extract_form_fields_request [ExtractFormFieldsRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineObject14, Integer, Hash)>] InlineObject14 data, response status code and response headers
    def extract_form_fields_with_http_info(extract_form_fields_request, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InlineObject14'
    ...
    # @param make_accessible_request [MakeAccessibleRequest] 
    # @param [Hash] opts the optional parameters
    # @return [InlineObject9]
    def make_accessible(make_accessible_request, opts = {})
      data, _status_code, _headers = make_accessible_with_http_info(make_accessible_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineObject9, Integer, Hash)>] InlineObject9 data, response status code and response headers
    def make_accessible_with_http_info(make_accessible_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServicesApi.make_accessible ...'
      end
      # verify the required parameter 'make_accessible_request' is set
      if @api_client.config.client_side_validation && make_accessible_request.nil?
        fail ArgumentError, "Missing the required parameter 'make_accessible_request' when calling ServicesApi.make_accessible"
      end
      # resource path
      local_var_path = '/pdfservices/make-accessible'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(make_accessible_request)
      ...
      new_options = opts.merge(
        :operation => :"ServicesApi.make_accessible",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ServicesApi#make_accessible\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param optimize_document_request [OptimizeDocumentRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineObject12, Integer, Hash)>] InlineObject12 data, response status code and response headers
    def optimize_document_with_http_info(optimize_document_request, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InlineObject12'
