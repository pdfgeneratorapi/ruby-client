...
module PDFGeneratorAPI
  class TemplatesApi
    ...
    # @param template_id [Integer] Template unique identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(DeleteTemplate200Response, Integer, Hash)>] DeleteTemplate200Response data, response status code and response headers
    def delete_template_with_http_info(template_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DeleteTemplate200Response'
    ...
    # @return [GetEditorUrl200Response]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :language Specify the editor UI language. Defaults to organization editor language.
    # @return [Array<(GetEditorUrl200Response, Integer, Hash)>] GetEditorUrl200Response data, response status code and response headers
    def get_editor_url_with_http_info(template_id, body, opts = {})
      ...
      allowable_values = ["en", "et", "cs", "sk", "ru", "de"]
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetEditorUrl200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['JSONWebTokenAuth']

      new_options = opts.merge(
        :operation => :"TemplatesApi.get_editor_url",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
