...
module PDFGeneratorAPI
  class TemplatesApi
    ...
    # @return [CreateTemplate200Response]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [CopyTemplateRequest] :copy_template_request 
    # @return [Array<(CreateTemplate200Response, Integer, Hash)>] CreateTemplate200Response data, response status code and response headers
    def copy_template_with_http_info(template_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateTemplate200Response'
