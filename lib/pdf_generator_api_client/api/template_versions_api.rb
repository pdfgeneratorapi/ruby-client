...
module PDFGeneratorAPI
  class TemplateVersionsApi
    ...
    # @param template_version [Integer] Unique ID of the template version.
    ...
    # @option opts [Integer] :page Page number to return.
    # @return [TemplateVersionCollection]
    ...
    # @option opts [Integer] :per_page Number of items per page.
    # @option opts [Integer] :page Page number to return.
    # @return [Array<(TemplateVersionCollection, Integer, Hash)>] TemplateVersionCollection data, response status code and response headers
    ...
    # @param template_version [Integer] Unique ID of the template version.
    # @param [Hash] opts the optional parameters
    # @return [PromoteTemplateVersion200Response]
    ...
    # @param template_version [Integer] Unique ID of the template version.
    # @param [Hash] opts the optional parameters
    # @return [Array<(PromoteTemplateVersion200Response, Integer, Hash)>] PromoteTemplateVersion200Response data, response status code and response headers
