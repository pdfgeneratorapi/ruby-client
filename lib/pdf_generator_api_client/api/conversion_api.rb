...
module PDFGeneratorAPI
  class ConversionApi
    ...
    # @param convert_pdf2_image_request [ConvertPDF2ImageRequest] 
    # @param [Hash] opts the optional parameters
    # @return [InlineObject10]
    def convert_pdf2_image(convert_pdf2_image_request, opts = {})
      data, _status_code, _headers = convert_pdf2_image_with_http_info(convert_pdf2_image_request, opts)
      data
    end
    ...
    # @param convert_pdf2_image_request [ConvertPDF2ImageRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineObject10, Integer, Hash)>] InlineObject10 data, response status code and response headers
    def convert_pdf2_image_with_http_info(convert_pdf2_image_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConversionApi.convert_pdf2_image ...'
      end
      # verify the required parameter 'convert_pdf2_image_request' is set
      if @api_client.config.client_side_validation && convert_pdf2_image_request.nil?
        fail ArgumentError, "Missing the required parameter 'convert_pdf2_image_request' when calling ConversionApi.convert_pdf2_image"
      end
      # resource path
      local_var_path = '/conversion/pdf2image'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(convert_pdf2_image_request)

      # return_type
      return_type = opts[:debug_return_type] || 'InlineObject10'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['JSONWebTokenAuth']

      new_options = opts.merge(
        :operation => :"ConversionApi.convert_pdf2_image",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConversionApi#convert_pdf2_image\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
