...
module PDFGeneratorAPI
  class FormsApi
    ...
    def delete_form_with_http_info(form_id, opts = {})
      ...
      # resource path
      local_var_path = '/forms/{formId}'.sub('{' + 'formId' + '}', CGI.escape(form_id.to_s))
    ...
    def share_form_with_http_info(form_id, opts = {})
      ...
      # verify the required parameter 'form_id' is set
      if @api_client.config.client_side_validation && form_id.nil?
        fail ArgumentError, "Missing the required parameter 'form_id' when calling FormsApi.share_form"
      end
      # resource path
      local_var_path = '/forms/{formId}/share'.sub('{' + 'formId' + '}', CGI.escape(form_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FormsApi#share_form\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_form_with_http_info(form_id, form_configuration_new, opts = {})
      ...
      # verify the required parameter 'form_configuration_new' is set
      if @api_client.config.client_side_validation && form_configuration_new.nil?
        fail ArgumentError, "Missing the required parameter 'form_configuration_new' when calling FormsApi.update_form"
      end
      # resource path
      local_var_path = '/forms/{formId}'.sub('{' + 'formId' + '}', CGI.escape(form_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"FormsApi.update_form",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
