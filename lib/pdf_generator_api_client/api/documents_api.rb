...
module PDFGeneratorAPI
  class DocumentsApi
    ...
    # @option opts [String] :output Response format. \&quot;I\&quot; is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.
    # @return [MergeTemplate200Response]
    def merge_template(template_id, body, opts = {})
      data, _status_code, _headers = merge_template_with_http_info(template_id, body, opts)
      data
    end
    ...
    # @option opts [String] :format Document format. The zip option will return a ZIP file with PDF files.
    # @option opts [String] :output Response format. \&quot;I\&quot; is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.
    # @return [Array<(MergeTemplate200Response, Integer, Hash)>] MergeTemplate200Response data, response status code and response headers
    def merge_template_with_http_info(template_id, body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DocumentsApi.merge_template"
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'MergeTemplate200Response'
    ...
    # @param batch_data_inner [Array<BatchDataInner>] Data used to specify templates and data objects which are used to merge the template
    # @param [Hash] opts the optional parameters
    # @option opts [String] :name Document name, returned in the meta data.
    # @option opts [String] :format Document format. The zip option will return a ZIP file with PDF files.
    # @option opts [String] :output Response format. \&quot;I\&quot; is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.
    # @return [MergeTemplate200Response]
    def merge_templates(batch_data_inner, opts = {})
      data, _status_code, _headers = merge_templates_with_http_info(batch_data_inner, opts)
      data
    end
    ...
    # @option opts [String] :output Response format. \&quot;I\&quot; is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.
    # @return [Array<(MergeTemplate200Response, Integer, Hash)>] MergeTemplate200Response data, response status code and response headers
    def merge_templates_with_http_info(batch_data_inner, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && batch_data_inner.nil?
        fail ArgumentError, "Missing the required parameter 'batch_data_inner' when calling DocumentsApi.merge_templates"
      end
      allowable_values = ["pdf", "html", "zip", "xlsx"]
      if @api_client.config.client_side_validation && opts[:'format'] && !allowable_values.include?(opts[:'format'])
        fail ArgumentError, "invalid value for \"format\", must be one of #{allowable_values}"
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(batch_data_inner)
