...
module PDFGeneratorAPI
  class DocumentsApi
    ...
    # @return [nil]
    def delete_document(public_id, opts = {})
      delete_document_with_http_info(public_id, opts)
      nil
    end
    ...
    def delete_document_with_http_info(public_id, opts = {})
    ...
    # @param generate_document_request [GenerateDocumentRequest] Request parameters, including template id, data and formats.
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineObject9, Integer, Hash)>] InlineObject9 data, response status code and response headers
    def generate_document_with_http_info(generate_document_request, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InlineObject9'
    ...
    def generate_document_asynchronous_with_http_info(generate_document_asynchronous_request, opts = {})
      ...
      if @api_client.config.client_side_validation && generate_document_asynchronous_request.nil?
        fail ArgumentError, "Missing the required parameter 'generate_document_asynchronous_request' when calling DocumentsApi.generate_document_asynchronous"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentsApi.generate_document_asynchronous",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentsApi#generate_document_asynchronous\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def generate_document_batch_asynchronous_with_http_info(generate_document_batch_asynchronous_request, opts = {})
      ...
      if @api_client.config.client_side_validation && generate_document_batch_asynchronous_request.nil?
        fail ArgumentError, "Missing the required parameter 'generate_document_batch_asynchronous_request' when calling DocumentsApi.generate_document_batch_asynchronous"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentsApi.generate_document_batch_asynchronous",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentsApi#generate_document_batch_asynchronous\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_async_job_status(job_id, opts = {})
      data, _status_code, _headers = get_async_job_status_with_http_info(job_id, opts)
      data
    end
    ...
    # @param job_id [String] Job id
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineObject13, Integer, Hash)>] InlineObject13 data, response status code and response headers
    def get_async_job_status_with_http_info(job_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentsApi.get_async_job_status ...'
      end
      # verify the required parameter 'job_id' is set
      if @api_client.config.client_side_validation && job_id.nil?
        fail ArgumentError, "Missing the required parameter 'job_id' when calling DocumentsApi.get_async_job_status"
      end
      # resource path
      local_var_path = '/documents/async/{jobId}'.sub('{' + 'jobId' + '}', CGI.escape(job_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InlineObject13'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['JSONWebTokenAuth']

      new_options = opts.merge(
        :operation => :"DocumentsApi.get_async_job_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentsApi#get_async_job_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_document(public_id, opts = {})
      data, _status_code, _headers = get_document_with_http_info(public_id, opts)
      data
    end
    ...
    # @param public_id [String] Resource public id
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineObject11, Integer, Hash)>] InlineObject11 data, response status code and response headers
    def get_document_with_http_info(public_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentsApi.get_document ...'
      end
      # verify the required parameter 'public_id' is set
      if @api_client.config.client_side_validation && public_id.nil?
        fail ArgumentError, "Missing the required parameter 'public_id' when calling DocumentsApi.get_document"
      end
      # resource path
      local_var_path = '/documents/{publicId}'.sub('{' + 'publicId' + '}', CGI.escape(public_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InlineObject11'
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :template_id Template unique identifier
    ...
    # @option opts [Integer] :page Pagination: page to return (default to 1)
    # @option opts [Integer] :per_page Pagination: How many records to return per page (default to 15)
    # @return [Array<(InlineObject15, Integer, Hash)>] InlineObject15 data, response status code and response headers
    def get_documents_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InlineObject15'
    ...
    # @param store_document_request [StoreDocumentRequest] Document source and optional metadata. Exactly one of &#x60;file_base64&#x60; or &#x60;file_url&#x60; is required.
    # @param [Hash] opts the optional parameters
    # @return [InlineObject11]
    def store_document(store_document_request, opts = {})
      data, _status_code, _headers = store_document_with_http_info(store_document_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineObject11, Integer, Hash)>] InlineObject11 data, response status code and response headers
    def store_document_with_http_info(store_document_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentsApi.store_document ...'
      end
      # verify the required parameter 'store_document_request' is set
      if @api_client.config.client_side_validation && store_document_request.nil?
        fail ArgumentError, "Missing the required parameter 'store_document_request' when calling DocumentsApi.store_document"
      end
      # resource path
      local_var_path = '/documents'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(store_document_request)
      ...
      new_options = opts.merge(
        :operation => :"DocumentsApi.store_document",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentsApi#store_document\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
