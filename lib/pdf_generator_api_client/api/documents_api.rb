...
module PDFGeneratorAPI
  class DocumentsApi
    ...
    # @param generate_document_asynchronous_request [GenerateDocumentAsynchronousRequest] Request parameters, including template id, data and formats.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GenerateDocumentAsynchronous201Response, Integer, Hash)>] GenerateDocumentAsynchronous201Response data, response status code and response headers
    def generate_document_asynchronous_with_http_info(generate_document_asynchronous_request, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GenerateDocumentAsynchronous201Response'
    ...
    # @param public_id [String] Resource public id
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDocument200Response, Integer, Hash)>] GetDocument200Response data, response status code and response headers
    def get_document_with_http_info(public_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetDocument200Response'
