...
module PDFGeneratorAPI
  class DocumentsApi
    ...
    # @option opts [String] :output Response format. \&quot;I\&quot; is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted. (default to 'base64')
