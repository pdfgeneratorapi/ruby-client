...
module PDFGeneratorAPI
  class DocumentsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [GenerateDocumentAsynchronous200Response]
    ...
    # @param generate_document_asynchronous_request [GenerateDocumentAsynchronousRequest] Request parameters, including template id, data and formats.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GenerateDocumentAsynchronous200Response, Integer, Hash)>] GenerateDocumentAsynchronous200Response data, response status code and response headers
    def generate_document_asynchronous_with_http_info(generate_document_asynchronous_request, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GenerateDocumentAsynchronous200Response'
