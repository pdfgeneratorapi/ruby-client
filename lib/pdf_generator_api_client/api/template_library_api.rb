...
module PDFGeneratorAPI
  class TemplateLibraryApi
    ...
    # @return [GetTemplateLibrary200Response]
    def get_template_library(opts = {})
      data, _status_code, _headers = get_template_library_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tags Filter template by tags
    # @return [Array<(GetTemplateLibrary200Response, Integer, Hash)>] GetTemplateLibrary200Response data, response status code and response headers
    def get_template_library_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TemplateLibraryApi.get_template_library ...'
      end
      # resource path
      local_var_path = '/templates/library'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetTemplateLibrary200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TemplateLibraryApi.get_template_library",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TemplateLibraryApi#get_template_library\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_template_library_item_with_http_info(public_id, opts = {})
      ...
      if @api_client.config.client_side_validation && public_id.nil?
        fail ArgumentError, "Missing the required parameter 'public_id' when calling TemplateLibraryApi.get_template_library_item"
      end
      # resource path
      local_var_path = '/templates/library/{publicId}'.sub('{' + 'publicId' + '}', CGI.escape(public_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TemplateLibraryApi.get_template_library_item",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TemplateLibraryApi#get_template_library_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
