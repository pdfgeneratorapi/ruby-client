...
module PDFGeneratorAPI
  class GetStatus200Response
    ...
    def self.openapi_types
      {
        :'api' => :'StatusParam',
        :'chart_api' => :'StatusParam',
        :'conversion_api' => :'StatusParam',
        :'generator_api_sync' => :'StatusParam',
        :'generator_api_async' => :'StatusParam',
        :'e_invoice' => :'StatusParam'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::GetStatus200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [api, chart_api, conversion_api, generator_api_sync, generator_api_async, e_invoice].hash
    end
