...
module PDFGeneratorAPI
  class CreateFacturXEInvoiceRequest
    ...
    def self.openapi_types
      {
        :'template' => :'CreateFacturXEInvoiceRequestTemplate',
        :'profile' => :'String',
        :'output' => :'OutputParam',
        :'name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::CreateFacturXEInvoiceRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::CreateFacturXEInvoiceRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      profile_validator = EnumAttributeValidator.new('String', ["basic", "basicwl", "en16931", "minimum", "extended", "xrechnung"])
    ...
    def profile=(profile)
      validator = EnumAttributeValidator.new('String', ["basic", "basicwl", "en16931", "minimum", "extended", "xrechnung"])
    ...
    def hash
      [template, profile, output, name, metadata].hash
    end
