  ...
  class ExtractFormFields200ResponseResponseValue
    ...
    def self.openapi_types
      {
        ...
        :'type' => :'String',
        :'name' => :'String',
        :'value' => :'ExtractFormFields200ResponseResponseValueValue',
        :'locked' => :'Boolean',
        :'pages' => :'Array<Integer>',
        :'default' => :'ExtractFormFields200ResponseResponseValueDefault',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::ExtractFormFields200ResponseResponseValue` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::ExtractFormFields200ResponseResponseValue`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'maxlen')
        self.maxlen = attributes[:'maxlen']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["textfield", "datefield", "checkbox", "radiobuttongroup", "combobox", "listbox"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["textfield", "datefield", "checkbox", "radiobuttongroup", "combobox", "listbox"])
    ...
    def hash
      [id, type, name, value, locked, pages, default, defaults, values, options, format, maxlen, multiline, editable, multi].hash
    end
