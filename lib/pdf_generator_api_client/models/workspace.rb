...
module PDFGeneratorAPI
  class Workspace
    ...
    attr_accessor :is_master_workspace
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::Workspace` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::Workspace`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_master_workspace')
        self.is_master_workspace = attributes[:'is_master_workspace']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_master_workspace == o.is_master_workspace &&
    ...
    def hash
      [id, identifier, is_master_workspace, created_at].hash
    end
