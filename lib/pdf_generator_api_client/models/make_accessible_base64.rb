...
module PDFGeneratorAPI
  class MakeAccessibleBase64
    ...
    def self.openapi_types
      {
        :'file_base64' => :'String',
        :'options' => :'Array<AccessibilityOption>',
        :'name' => :'String',
        :'output' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::MakeAccessibleBase64` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::MakeAccessibleBase64`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      output_validator = EnumAttributeValidator.new('String', ["base64", "file", "url", "viewer"])
    ...
    def output=(output)
      validator = EnumAttributeValidator.new('String', ["base64", "file", "url", "viewer"])
    ...
    def hash
      [file_base64, options, name, output, metadata].hash
    end
