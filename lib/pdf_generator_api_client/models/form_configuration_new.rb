  ...
  class FormConfigurationNew
    ...
    def self.openapi_types
      {
        :'template_id' => :'Integer',
        :'name' => :'String',
        :'actions' => :'Array<FormConfigurationNewActionsInner>',
        :'fields' => :'Array<FormFieldsInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::FormConfigurationNew` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::FormConfigurationNew`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [template_id, name, actions, fields, configuration].hash
    end
