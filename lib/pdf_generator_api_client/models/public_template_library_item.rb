  ...
  class PublicTemplateLibraryItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::PublicTemplateLibraryItem` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::PublicTemplateLibraryItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sample_data_url')
        self.sample_data_url = attributes[:'sample_data_url']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sample_data_url == o.sample_data_url
    end
    ...
    def hash
      [id, name, tags, preview_image_url, sample_data_url].hash
    end
