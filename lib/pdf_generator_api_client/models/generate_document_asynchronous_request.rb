  ...
  class GenerateDocumentAsynchronousRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::GenerateDocumentAsynchronousRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::GenerateDocumentAsynchronousRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'make_accessible')
        self.make_accessible = attributes[:'make_accessible']
      else
        self.make_accessible = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          testing == o.testing &&
          make_accessible == o.make_accessible &&
          metadata == o.metadata
    end
    ...
    def hash
      [template, callback, format, output, name, testing, make_accessible, metadata].hash
    end
