  ...
  class TemplateDefinitionNew
    ...
    def self.attribute_map
      {
        ...
        :'editor' => :'editor',
        :'font_subsetting' => :'fontSubsetting',
        :'barcode_as_image' => :'barcodeAsImage'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'pages' => :'Array<TemplateDefinitionNewPagesInner>',
        :'data_settings' => :'TemplateDefinitionNewDataSettings',
        :'editor' => :'TemplateDefinitionNewEditor',
        :'font_subsetting' => :'Boolean',
        :'barcode_as_image' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::TemplateDefinitionNew` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::TemplateDefinitionNew`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_settings')
        self.data_settings = attributes[:'data_settings']
      end
      ...
      if attributes.key?(:'font_subsetting')
        self.font_subsetting = attributes[:'font_subsetting']
      else
        self.font_subsetting = false
      end

      if attributes.key?(:'barcode_as_image')
        self.barcode_as_image = attributes[:'barcode_as_image']
      else
        self.barcode_as_image = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          layout == o.layout &&
          pages == o.pages &&
          data_settings == o.data_settings &&
          editor == o.editor &&
          font_subsetting == o.font_subsetting &&
          barcode_as_image == o.barcode_as_image
    end
    ...
    def hash
      [name, tags, is_draft, layout, pages, data_settings, editor, font_subsetting, barcode_as_image].hash
    end
