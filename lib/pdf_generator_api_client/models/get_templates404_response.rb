...
module PDFGeneratorAPI
  class GetTemplates404Response
    ...
    def valid?
      error_validator = EnumAttributeValidator.new('String', ["Entity not found", "Resource not found", "None of the templates is available for the workspace."])
    ...
    def error=(error)
      validator = EnumAttributeValidator.new('String', ["Entity not found", "Resource not found", "None of the templates is available for the workspace."])
