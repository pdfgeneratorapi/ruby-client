...
module PDFGeneratorAPI
  ...
  class TemplateDefinitionNewLayout
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'rotaion')
        self.rotaion = attributes[:'rotaion']
      end
    ...
    def valid?
      ...
      rotaion_validator = EnumAttributeValidator.new('Integer', [0, 90, 180, 270])
      return false unless rotaion_validator.valid?(@rotaion)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] rotaion Object to be assigned
    def rotaion=(rotaion)
      validator = EnumAttributeValidator.new('Integer', [0, 90, 180, 270])
      unless validator.valid?(rotaion)
        fail ArgumentError, "invalid value for \"rotaion\", must be one of #{validator.allowable_values}."
      end
      @rotaion = rotaion
    end
    ...
    def hash
      [format, width, height, unit, orientation, rotaion, margins, repeat_layout, empty_labels].hash
    end
