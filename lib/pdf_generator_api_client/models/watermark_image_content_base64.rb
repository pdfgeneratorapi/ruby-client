  ...
  class WatermarkImageContentBase64
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::WatermarkImageContentBase64` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::WatermarkImageContentBase64`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'content_base64')
        self.content_base64 = attributes[:'content_base64']
      else
    ...
    def list_invalid_properties
      ...
      if @content_base64.nil?
        invalid_properties.push('invalid value for "content_base64", content_base64 cannot be nil.')
      end

      if !@rotation.nil? && @rotation > 180
        invalid_properties.push('invalid value for "rotation", must be smaller than or equal to 180.')
      end

      if !@rotation.nil? && @rotation < -180
        invalid_properties.push('invalid value for "rotation", must be greater than or equal to -180.')
      end
      ...
      if !@scale.nil? && @scale < 0.05
        invalid_properties.push('invalid value for "scale", must be greater than or equal to 0.05.')
      end
    ...
    def valid?
      ...
      return false if @content_base64.nil?
      return false if !@rotation.nil? && @rotation > 180
      return false if !@rotation.nil? && @rotation < -180
      return false if !@scale.nil? && @scale > 1
      return false if !@scale.nil? && @scale < 0.05
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] content_base64 Value to be assigned
    def content_base64=(content_base64)
      if content_base64.nil?
        fail ArgumentError, 'content_base64 cannot be nil'
      end
    ...
    def rotation=(rotation)
      ...
      if rotation > 180
        fail ArgumentError, 'invalid value for "rotation", must be smaller than or equal to 180.'
      end

      if rotation < -180
        fail ArgumentError, 'invalid value for "rotation", must be greater than or equal to -180.'
      end
    ...
    def scale=(scale)
      ...
      if scale < 0.05
        fail ArgumentError, 'invalid value for "scale", must be greater than or equal to 0.05.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          content_base64 == o.content_base64 &&
          position == o.position &&
          rotation == o.rotation &&
          scale == o.scale
    end
    ...
    def hash
      [content_base64, position, rotation, scale].hash
    end
