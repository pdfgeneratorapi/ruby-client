  ...
  class EncryptAndDecryptBase64
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PDFGeneratorAPI::EncryptAndDecryptBase64` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PDFGeneratorAPI::EncryptAndDecryptBase64`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @file_base64.nil?
        invalid_properties.push('invalid value for "file_base64", file_base64 cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @file_base64.nil?
      return false if @owner_password.nil?
      output_validator = EnumAttributeValidator.new('String', ["file", "base64", "url"])
      return false unless output_validator.valid?(@output)
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] file_base64 Value to be assigned
    def file_base64=(file_base64)
      if file_base64.nil?
        fail ArgumentError, 'file_base64 cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] owner_password Value to be assigned
    def owner_password=(owner_password)
      if owner_password.nil?
        fail ArgumentError, 'owner_password cannot be nil'
      end
    ...
    def output=(output)
      validator = EnumAttributeValidator.new('String', ["file", "base64", "url"])
    ...
    def hash
      [file_base64, owner_password, user_password, name, output].hash
    end
