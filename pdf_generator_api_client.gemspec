...
Gem::Specification.new do |s|
  s.name        = "pdf_generator_api_client"
  s.version     = PDFGeneratorAPI::VERSION
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["OpenAPI-Generator"]
  s.email       = ["support@pdfgeneratorapi.com"]
  s.homepage    = "https://github.com/pdfgeneratorapi/ruby-client"
  s.summary     = "Ruby wrapper for PDF Generator API"
  s.description = "Ruby wrapper for PDF Generator API"
  s.license     = "Unlicense"
